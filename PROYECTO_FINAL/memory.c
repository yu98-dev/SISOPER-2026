...
/* Variables globales - tipos definidos en memory.h */
...
/*
 * init_memoria
 * Inicializa todos los subsistemas de memoria.
...
void init_memoria(void) {
    ...
    init_page_table();
    init_seg_table();
    printf("[MEM] Modulo de memoria inicializado.\n");
}

/*
 * menu_memoria
 * Menu interactivo completo del modulo de memoria.
 * El kernel lo invoca como submenu desde su menu principal.
 * Antes era el main() de memory.c.
 */
